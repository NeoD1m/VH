...
using UnityEngine;
/*
 * https://github.com/mminer/consolation/blob/master/Console.cs
 * https://github.com/mminer/consolation/blob/master/Console.cs
 * https://github.com/mminer/consolation/blob/master/Console.cs
 */
...
namespace Consolation
{
    ...
    class Console : MonoBehaviour
    {
        ...
        public int TRUEmaxLogCount = 100;
        #endregion

        static readonly GUIContent clearLabel = new GUIContent("Clear", "Clear the contents of the console.");
        static readonly GUIContent onlyOne = new GUIContent("AutoScroll", "Scroll till the end");
        ...
        void OnGUI()
        {
            ...
            Rect newWindowRect = GUILayout.Window(123456, windowRect, DrawWindow, windowTitle, GUIStyle.none);
        ...
        {
            UpdateQueuedLogs();
            while(logs.Count > TRUEmaxLogCount)
            {
                logs.RemoveAt(0);
            }
        ...
        void DrawLog(Log log, GUIStyle logStyle, GUIStyle badgeStyle)
        {
            ...
            if (isCollapsed)
            {
                ...
                GUILayout.Label(log.count.ToString());
